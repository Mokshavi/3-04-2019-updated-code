                ...
                for i in listofcards:
                    try:
                        ...
                        if lane_ClassType == 'backlog':
                            ...
                            card_title_list.append(card_Details_data["card_title"])
                            engineNo_list.append(card_Details_data["engineNo"])
                            engpartNo_list.append(card_Details_data["partNo"])
                            customId_ConsessionNo_list.append(card_Details_data["customId_ConsessionNo"])
                            plannedFinish_list.append(card_Details_data["plannedFinish"])
                            externalLinks_list.append(card_Details_data["externalLinks"])
                            card_ID_list.append(card_Details_data["card_ID"])
                            lane_ID_list.append(card_Details_data["lane_ID"])
                            lane_ClassType_list.append(card_Details_data["lane_ClassType"])
                            priority_list.append(card_Details_data["priority"])
                            card_size_list.append(card_Details_data["card_size"])
                            card_type_list.append(card_Details_data["card_type"])
